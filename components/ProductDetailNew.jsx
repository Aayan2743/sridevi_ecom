...
export default function ProductDetailNew({ product, onBack }) {
  ...
  return (
    <div
      className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-red-50/20"
      ref={containerRef}
    >
      ...
      <div className="max-w-8xl mx-auto px-6 py-12">
          ...
          >
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent">
                  <div className="absolute bottom-0 left-0 right-0 p-8 text-white">
                    ...
                    <p className="opacity-90 leading-relaxed">
                      Discover the traditional preparation methods and amazing
                      benefits.
                    </p>
                  </div>
                </div>
              ...
              <div className="px-8 py-6 bg-gray-50 border-t">
                <div className="flex items-center justify-between">
                  ...
                  <motion.button
                    ...
                    onClick={() =>
                      toast.info("Full screen feature coming soon!")
                    }
            ...
            >
              <div className="flex items-start gap-6">
                ...
                <div>
                  <h4 className="font-bold text-green-900 text-xl mb-3">
                    100% Natural & Pure
                  </h4>
                  <p className="text-green-700 leading-relaxed mb-4 text-lg">
                    Crafted using traditional Ayurvedic methods with premium
                    herbs sourced directly from organic farms.
                  </p>
                  <div className="flex items-center gap-3 text-green-600">
              ...
              <div className="space-y-6">
                <div className="p-6 bg-yellow-50 rounded-2xl border border-yellow-200">
                  ...
                  <p className="text-gray-600 italic leading-relaxed">
                    &ldquo;Amazing quality! Exactly as shown in the video.
            ...
            <div>
              ...
              <div className="prose prose-gray max-w-none">
                <p className="text-gray-600 leading-relaxed text-xl">
                  {product.description ||
                    "This premium herbal product is carefully crafted using traditional Ayurvedic methods passed down through generations. Each ingredient is sourced from certified organic farms and processed using time-tested techniques to preserve maximum potency and effectiveness."}
                </p>
              </div>
            </div>
            <div>
        ...
        <div className="fixed bottom-0 left-0 right-0 bg-white/95 backdrop-blur-xl border-t border-gray-200 p-6 shadow-2xl lg:hidden z-50">
          <div className="flex gap-4 max-w-md mx-auto">
            ...
            >
              <Heart
                className={`w-7 h-7 ${inWishlist ? "fill-current" : ""}`}
              />
            </motion.button>
            <motion.button
              whileTap={{ scale: 0.95 }}
